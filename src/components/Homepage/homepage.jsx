...
const homepage = () => {
 ...
 <div className='m-auto flex gap-7 ui-btn2 absolute place-content-left ml-7 -mt-[2rem]' >
    ...
    <a href="https://t.me/fasttracklistingz"> 
        <button class="ui-btn ui-btn1 cursor-pointer   m-auto mt-10 uppercase ">
            <span class="text-white">
              Get In Touch
            </span>
          </button>
...
{/* main_container */}
     ...
     {/* our team */}
     <div className='mt-20'>
     <h1 className='text-white  underlineMe_Mv1 underlineMe_Mv2 underlineMe   text-wrap text-5xl text-center jockey-one-regular text4' data-aos='fade' data-aos-duration='2000'>
                  Our Team
               </h1>
         <div className='flex place-content-center mt-14 gap-8 teamCard'>
...
{/* team members */}
        ...
        <div class="card">
        <div class="card-info">
        <div class=""><img src={face1} alt="" className='rounded-full w-28 h-28 mb-2 object-cover ' /></div>
